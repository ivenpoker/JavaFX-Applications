...
public class InvalidationTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Before changing the counter value");
        counter.set(1);
        System.out.println("After changing the counter value");

        // At this point the counter is invalid and further changes
